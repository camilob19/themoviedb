...
struct Localized {
    ...
    static let likeText = "like".localized()
    
    //Popular Movies
    static let placeholderSearch = "placeholder_search".localized()
    static let navigationTitle = "navigation_title".localized()
    
    //Movie Detail
    static let formatReviews = "format_reviews".localized()
